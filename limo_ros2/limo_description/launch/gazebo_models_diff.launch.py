...
def generate_launch_description():
  ...
  urdf_file_path = 'urdf/limo_four_diff.xacro'  # ← 필요시 heavy 버전 파일명으로 바꿔줘
  ...
  # --- 핵심 수정: xacro를 실행해 나온 문자열을 robot_description에 넣고, 문자열로 고정 ---
  robot_description = ParameterValue(
    Command([FindExecutable(name='xacro'), ' ', urdf_model]),
    value_type=str
  )
  ...
  # Launch the robot (spawn from /robot_description)
  ...
  ld.add_action(start_robot_state_publisher_cmd)  # robot_description 먼저 퍼블리시
